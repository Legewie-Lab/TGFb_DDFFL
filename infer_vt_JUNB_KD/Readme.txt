This directory contains the Matlab script (main_infer_vt.m) and datasets used for inference of the input transcription rates of genes in three classes, i.e., DDGs, delayed and biphasic, upon JUNB knockdown (KD). The Parallel Computing Toolbox was used in the Matlab script to speedup the calculation. 
